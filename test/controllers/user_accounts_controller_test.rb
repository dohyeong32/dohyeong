...
class UserAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_account" do
    assert_difference('UserAccount.count') do
      post user_accounts_url, params: { user_account: { acount_number: @user_account.acount_number, bank_name: @user_account.bank_name, cash: @user_account.cash, user_id: @user_account.user_id } }
    end
  ...
  test "should update user_account" do
    patch user_account_url(@user_account), params: { user_account: { acount_number: @user_account.acount_number, bank_name: @user_account.bank_name, cash: @user_account.cash, user_id: @user_account.user_id } }
